...
function cellIDToBoardIndices(cID){
    const col = cID.charCodeAt(0) - 'a'.charCodeAt(0);
    const row = 8 - parseInt(cID[1], 10);
    return [row, col];
}
...
function addPossibleMove(row, col){
    let possCell = document.getElementById(boardIndicesTocellID(row, col));
...
function kingPossibleMoves(king){
    ...
    if(boardColor == 'white'){
        ...
        if(indexColKing - 1 >= 0){
            if(castle.includes('Q') && indexRowKing == 7 && indexColKing == 4 && !checked){ // King hasn't moved and isn't under check
                if(board[indexRowKing][indexColKing - 1] == '1' && board[indexRowKing][indexColKing - 2] == '1' && board[indexRowKing][indexColKing - 3] == '1'){
                    if(canKingMoveThere(indexRowKing, indexColKing, indexRowKing, indexColKing - 2) && canKingMoveThere(indexRowKing, indexColKing, indexRowKing, indexColKing - 1)){
                        kingMoves.push(indexRowKing, indexColKing - 1);
                        kingMoves.push(indexRowKing, indexColKing - 2);
                    }
                    else if(canKingMoveThere(indexRowKing, indexColKing, indexRowKing, indexColKing - 1)){
                        kingMoves.push(indexRowKing, indexColKing - 1);
                    }
                }
                else {
        ...
        if(indexColKing + 1 <= 7){
            if(castle.includes('K') && indexRowKing == 7 && indexColKing == 4 && !checked){  // King hasn't moved and isn't under check
        ...
        // Left (including castle)
        if(indexColKing + 1 <= 7){
            if(castle.includes('k') && indexRowKing == 0 && indexColKing == 4 && !checked){
                if(board[indexRowKing][indexColKing + 1] == '1' && board[indexRowKing][indexColKing + 2] == '1'){
                    if(canKingMoveThere(indexRowKing, indexColKing, indexRowKing, indexColKing + 2) && canKingMoveThere(indexRowKing, indexColKing, indexRowKing, indexColKing + 1)){
                        kingMoves.push(indexRowKing, indexColKing + 1);
                        kingMoves.push(indexRowKing, indexColKing + 2);
        ...
        // Right (including castle)
        if(indexColKing - 1 >= 0){
            if(castle.includes('q') && indexRowKing == 0 && indexColKing == 4 && !checked){
                if(board[indexRowKing][indexColKing - 1] == '1' && board[indexRowKing][indexColKing - 2] == '1' && board[indexRowKing][indexColKing - 3] == '1'){
                    if(canKingMoveThere(indexRowKing, indexColKing, indexRowKing, indexColKing - 2) && canKingMoveThere(indexRowKing, indexColKing, indexRowKing, indexColKing - 1)){
                        kingMoves.push(indexRowKing, indexColKing - 1);
                        kingMoves.push(indexRowKing, indexColKing - 2);
